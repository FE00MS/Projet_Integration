                    ...
                    <div class="navbar-start">
                        <div class="dropdown">
                            ...
                            <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                                ...
                                <li>
                                    <a onclick="changeLanguage('$lang')" class="btn btn-ghost"> $lang</a>
                                </li>
                                <li>
                                    <a href="profile.php" title="$Name" class="btn btn-ghost">{$translations['headerAbout']}</a>
                                </li>
                                <li>    
                        ...
                        <a href="myOffers.php" class="btn btn-ghost normal-case text-xl">
                ...
                <div class="navbar bg-base-100 w-full sticky top-0 shadow-md z-50 mb-6">
                    <div class="navbar-start">
                        <div class="dropdown">
                            ...
                            <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                                <li><a href="index.php"class="btn btn-ghost">{$translations['headerHomepage']}</a></li>
                                <li><a href="myApplications.php" class="btn btn-ghost">{$translations['headerApplications']}</a></li>
                                <li><a href="about.php" class="btn btn-ghost">{$translations['headerAbout']}</a></li>
                                <li><a href="aide.php" class="btn btn-ghost">{$translations['headerHelp']}</a></li>
                                    <li>
                                        <a onclick="changeLanguage('$lang')" class="btn btn-ghost"> $lang</a>
                                    </li>
                                    <li>
...
if ($isLoggedIn && $accountType != "admin") {
    $header .= <<<HTML
            ...
            <a href="profile.php" title="$Name" class="btn btn-ghost">
                <svg  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                </svg>      
            </a>
